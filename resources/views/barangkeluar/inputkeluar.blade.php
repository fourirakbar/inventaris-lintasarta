...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Form Alokasi Barang Keluar</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Form Alokasi Barang Keluar</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" role="form" action="{{ URL::to('barangkeluar') }}">
              <div class="box-body">
                ...
                <div class="form-group"> 
                  ...
                  <input class="form-control" placeholder="Masukkan Nomor Ticket" name="NO_TICKET" id="nomorticket"> 
                </div> 
                {{csrf_field()}}
                <div class="form-group"> 
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="date" class="form-control pull-right" id="datepicker" name="TGL_KELUAR">
                  </div>
                  <!-- /.input group -->
                </div>                 
              </div>
