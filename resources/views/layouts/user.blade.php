<head>
	...
	<!-- Theme style -->
	<link rel="stylesheet" href="{{URL::asset('dist/css/userLTE.min.css')}}">
...
<div class="wrapper">
	<header class="main-header">
	    ...
	    <nav style="text-align: center;" class="navbar navbar-static-top">
	    	<span style="font-size: 30px; color: white;">Sistem Dokumentasi dan Monitoring TI Infrastruktur</span>
	    </nav>
	</header>
