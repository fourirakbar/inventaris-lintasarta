...
<body>
    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
            <h2 style="color: red"><span style="color: yellow" class="fa fa-exclamation-triangle" aria-hidden="true""></span>Mohon maaf, nomor tiket yang anda masukkan tidak dapat kami temukan :(</h2>
            <br>
            <div class="s-bar">
               <form role="form" method="POST" role="form" action="{{ URL::to('user-search') }}">
                <input autocomplete="off" type="text" name="NO_TIKET" value="Masukkan nomor tiket yang lain" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Masukkan nomor tiket yang lain';}">
                {{csrf_field()}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h4><strong>APLIKASNUSA LINTASARTA</strong>
                    </h4>
                    <p>Menara Thamrin 11th Floor
                        <br>Jl. M.H. Thamrin Kav. 3<br>
                        Central Jakarta 10250</p>
                    <ul class="list-unstyled">
                        <li><i class="fa fa-phone fa-fw"></i> +6221 230 2345 (Hunting)</li>
                        </li>
                    </ul>
                    <br>
                    <hr class="small">
